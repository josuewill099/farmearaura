...
LOCS = ["ar", "mx", "es", "br", "cl", "pe", "co", "us", "esus", "uy", "pt", "ec", "ve", "cr", "gt"]
...
HOME = {"ar": "/", "mx": "/mx/", "es": "/es/", "br": "/br/",
        ...
        "uy": "/uy/", "pt": "/pt/", "ec": "/ec/", "ve": "/ve/", "cr": "/cr/", "gt": "/gt/"}
...
OG = {"ar": "es_AR", "mx": "es_MX", "es": "es_ES", "br": "pt_BR", "us": "en_US",
      ...
      "pt": "pt_PT", "ec": "es_EC", "ve": "es_VE", "cr": "es_CR", "gt": "es_GT"}
...
RANKING_CTA = {
    ...
    "cr": "Vota tú y muévelo.", "gt": "Votá vos y movelo.",
}
HISTORIAL_CTA = {
    ...
    "ve": "Suma tu duelo.", "cr": "Suma tu duelo.", "gt": "Sumá tu duelo.",
}
...
FAMOSOS_LABEL = {
    ...
    "cr": "Duelos entre famosos", "gt": "Duelos entre famosos",
}
