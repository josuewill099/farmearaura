...
LOCS = ["ar", "mx", "es", "br", "cl", "pe", "co", "us", "esus", "uy", "pt", "ec", "ve", "cr"]
...
OG = {"ar": "es_AR", "mx": "es_MX", "es": "es_ES", "br": "pt_BR", "us": "en_US",
      ...
      "pt": "pt_PT", "ec": "es_EC", "ve": "es_VE", "cr": "es_CR"}
...
HISTORIAL_CTA = {
    ...
    "ve": "Suma tu duelo.", "cr": "Suma tu duelo.",
}
